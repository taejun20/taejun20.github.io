...
![IBM SPSS Statistics 25버전|50%](img/posts/200203-spss-repeated-measures/overview.png)
...
![](img/posts/200203-spss-repeated-measures/normality-step1.png)

2. 검사하려는 변수를 종속변수에 추가한 후 '통계량' 클릭

![](img/posts/200203-spss-repeated-measures/normality-step2.png)

3. 아래 옵션으로 설정 후 '계속' 클릭

![](img/posts/200203-spss-repeated-measures/normality-step3.png)

4. 도표 클릭

![](img/posts/200203-spss-repeated-measures/normality-step4.png)

5. 아래 옵션으로 설정 후 '계속' 클릭

![](img/posts/200203-spss-repeated-measures/normality-step5.png)

6. '확인' 클릭

## 결과 분석

![](img/posts/200203-spss-repeated-measures/normality-result.png)
...
![](img/posts/200203-spss-repeated-measures/anova-step1.png)

2. 요인 이름, 측도 이름을 임의로 정함. 수준 수에는 조건 개수 입력. 추가한 뒤 '정의' 클릭

![](img/posts/200203-spss-repeated-measures/anova-step2.png)

3. 왼쪽의 Column들을 개체-내 변수로 이동

![](img/posts/200203-spss-repeated-measures/anova-step3.png)

4. 'EM 평균' 클릭. 독립 변수를 오른쪽으로 옮기고 '주효과 비교' 체크, 아래는 Bonferroni 선택

![](img/posts/200203-spss-repeated-measures/anova-step4.png)

5. '옵션' 클릭. '기술통계량' 체크

![](img/posts/200203-spss-repeated-measures/anova-step5.png)
...
![](img/posts/200203-spss-repeated-measures/anova-result-sphericity.png)

```note
- Mauchly's Test에서 유의 확률(p-value)이 0.05보다 크면 구형성 만족
- 본 데이터는 구형성이 만족됨
- 구형성이 만족되지 않으면 significant effect를 볼 때 Greenhouse-Geisser (p < 0.05 && Greenhouse-Geisser Epsilon < 0.75) 혹은 Huynh-Feldt (p < 0.05 && Greenhouse-Geisser Epsilon > 0.75) 에 따른 결과를 사용해야 한다.
- Repeated Measure의 level이 여기서는 3개지만, 2개라면 자동으로 구형성이 만족되어 체크할 필요가 없다.
```

**방법 간 차이의 significant effect 체크**

![](img/posts/200203-spss-repeated-measures/anova-result-effect.png)
...
![](img/posts/200203-spss-repeated-measures/anova-result-posthoc.png)
...
![](img/posts/200203-spss-repeated-measures/friedman-step1.png)

2. 왼쪽의 Column들을 검정 변수로 이동. 아래 Friedman에 체크된 것 확인

![](img/posts/200203-spss-repeated-measures/friedman-step2.png)

3. '통계량' 클릭 → '사분위수' 체크 후 '계속' 클릭

![](img/posts/200203-spss-repeated-measures/friedman-step3.png)

4. '확인' 클릭

## 결과 분석 (1)

![](img/posts/200203-spss-repeated-measures/friedman-result.png)
...
![](img/posts/200203-spss-repeated-measures/wilcoxon-step1.png)

2. 비교하고 싶은 변수의 pair를 모두 오른쪽으로 옮긴다

![](img/posts/200203-spss-repeated-measures/wilcoxon-step2.png)

3. '옵션' 클릭 → '기술통계', '사분위수' 체크 후 '계속' 클릭

![](img/posts/200203-spss-repeated-measures/wilcoxon-step3.png)

4. '확인' 클릭

## 결과 분석 (2) — 사후 분석 (Wilcoxon signed-rank test)

![](img/posts/200203-spss-repeated-measures/wilcoxon-result.png)
